...
class Search:
    def __init__(self, index_dir="indexdir", field_weights=None):
        ...
        :param field_weights: Dictionary specifying weights for BM25F (if needed).
        """
        self.index_dir = index_dir
        self.field_weights = field_weights or {"title": 2.0, "headder": 1.5, "content": 1.0}
        self.ix = open_dir(self.index_dir)

    def search_default(self, query_str, limit=10):
        """
        Perform a default search across all fields using TF-IDF scoring.
        ...
        with self.ix.searcher() as searcher:
            ...
            parser = MultifieldParser(["title", "headder", "content"], self.ix.schema)
